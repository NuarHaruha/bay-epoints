...
<div class="wrap ewallet receipt">
    <div id="icon-wallet" class="icon32"></div>
    <h2 class="">Receipt <?php ew_format_receipt($_REQUEST); ?></h2>
    <?php settings_errors(); ?>
    <?php do_action('mc_notification', $_REQUEST);?>
    <form name="report-form" method="post">
        <input type="hidden" name="action" value="mc-wallet-receipt">
        ...
        <div id="poststuff">
            <div id="post-body" class="metabox-holder columns-<?php echo 1 == get_current_screen()->get_columns() ? '1' : '2'; ?>">
                <div id="post-body-content" class="dn">
                    <?php do_action('main_ewallet_receipt_content', $_REQUEST); ?>
                </div>
